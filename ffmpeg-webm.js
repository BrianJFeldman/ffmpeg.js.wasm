...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'ffmpeg-webm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'ffmpeg-webm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'ffmpeg-webm.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "ffmpeg-webm.js.mem" : null;

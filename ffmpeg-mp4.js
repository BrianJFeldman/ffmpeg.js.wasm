...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'ffmpeg-mp4.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'ffmpeg-mp4.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'ffmpeg-mp4.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "ffmpeg-mp4.js.mem" : null;
